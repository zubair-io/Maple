...
- **Open** — the option list renders as a popover using this system's elevation rule: hairline by
  default, shadow only when a surface lifts off the page (see the unified design guide's elevation
  principle).
