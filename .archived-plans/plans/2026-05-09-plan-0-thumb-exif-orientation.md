...
**Spec:** [`.archived-plans/specs/2026-05-09-stage-controllers-design.md`](../specs/2026-05-09-stage-controllers-design.md) — Architecture → Dependency graph (the `thumb → [hash, exif]` edge motivates this fix; lands as a standalone commit before the full redesign).
