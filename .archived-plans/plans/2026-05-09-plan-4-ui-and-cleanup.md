...
**Spec:** [`.archived-plans/specs/2026-05-09-stage-controllers-design.md`](../specs/2026-05-09-stage-controllers-design.md) — §"UI" (row layout) and §"Versioning + auto-backfill semantics" (rescan rewrite).
