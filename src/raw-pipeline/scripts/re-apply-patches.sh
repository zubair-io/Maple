...
#
# SCOPE: this script patches crates under vendor/ ONLY. Not every patch in
# patches/ belongs to it — patches/rav1d-1.1.0-c-unwind.patch is applied to the
# hand-maintained copy at third_party/rav1d/ instead, which is a `[patch.crates-io]`
# path override and therefore not regenerated by `cargo vendor` (rav1d is no
# longer emitted into vendor/ at all). See third_party/rav1d/MAPLE-PATCH.md.
#
