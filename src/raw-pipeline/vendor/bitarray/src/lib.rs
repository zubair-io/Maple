//! Vendored bitarray 0.2.6 — identical to the published crate except the
//! `#![feature(min_const_generics)]` attribute has been removed.  That
//! feature stabilised in Rust 1.51; the attribute is not only unnecessary
//! but actively rejected by stable Rust (E0554).
#![no_std]
#![cfg_attr(
