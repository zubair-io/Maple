...
Refs: docs/superpowers/plans/2026-04-25-ticket-07-linearraw-decode.md
...
Append to the brief at `docs/superpowers/specs/2026-04-25-ticket-07-linearraw-decode-brief.md` (or to a new section in this plan, depending on convention used by sibling plans) a one-paragraph M1 record:
