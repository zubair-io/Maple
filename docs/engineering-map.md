...
| `MapleExporter.swift`, `Panorama`, `Masks`, `Retouch`     | Editing workflows and orchestration around shared processing                    | Review semantic behavior at Rust/binding boundaries, not just Swift file boundaries                        |
