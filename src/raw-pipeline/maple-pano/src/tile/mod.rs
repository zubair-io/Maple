...
//! | `frame_cache.rs` | On-demand decode cache bounding tile-path RSS (#3090/#3197) |
//! | `frame_window.rs` | Spatial cell + capacity-bounded wave grouping shared by the full-canvas scans (#3197) |
