...
final class EditorStateTests: XCTestCase {
    ...
    func testTwentyNineToolsExist() {
        ...
        // Corrections in Detail (#2231), + Mask in Detail (#355).
        XCTAssertEqual(Tool.allCases.count, 30)
    }
    ...
    func testToolGroupMembership() {
        ...
        // Lens Corrections (#2231): 7 → 8, then Mask (#355): 8 → 9.
        XCTAssertEqual(Tool.tools(in: .detail).count, 9)
    }
