...
pub struct SliderFrameExport {
    ...
    /// hands the app for slider hydration). May sit at the ±100 rail for
    /// bodies whose as-shot chromaticity is far off the locus.
...
/// tint estimator — displace along the SAME positive-v perpendicular axis
