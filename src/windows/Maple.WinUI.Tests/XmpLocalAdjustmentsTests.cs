...
// literal appears in the Rust suite (`raw-core/src/xmp/tests_local_adjustments_canonical.rs`),
...
namespace Maple.WinUI.Tests
{
    ...
    {
        internal const string CanonicalIndent = "      ";
        ...
        internal static readonly LocalAdjustment RadialLayer = new(
            ...
            // The six spatial controls (#3407) are all non-default here so the
            // four-writer golden pins their keys, their Adobe ±1 fraction scale
            // and their emission order. Clarity = 35 is the ticket's own
            // Lightroom example, which stores as crs:LocalClarity2012="0.35".
        ...
        internal const string FullFrameGradient =
        ...
        internal static string Sidecar(string children) => string.Join("\n", new[]
        {
        ...
        internal static string GradientCorrection(string descriptionAttrs, string maskLeaf) => string.Join("\n", new[]
        {
            "      <crs:GradientBasedCorrections>",
            "        <rdf:Seq>",
            "          <rdf:li>",
        ...
        public void ImportsALightroomRadialCorrectionIgnoringUnmodeledAttributes()
        {
            ...
            Assert.Equal(new[]
            {
                new LocalAdjustment(
                    ...
                    new PartialAdjustments { Saturation = -15, Clarity = 20, Temperature = -50 }),
            }, doc!.Adjustments.LocalAdjustments);
        }
