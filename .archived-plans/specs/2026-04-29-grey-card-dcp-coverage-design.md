...
Plan implemented at `.archived-plans/plans/2026-04-29-grey-card-dcp-coverage.md`. Tasks 1-12 + 18 landed; Tasks 13-17 (HSM/LookTable/GainTableMap integration tests) deferred — infrastructure is in place, the marked-cell HSM predictor and LUT tag wiring on `SyntheticColorChart` remain.
