// The legacy display-encoded decode request — split out of
// `raw-pipeline.types.ts` (file-size budget, #3479) and re-exported from
// there so every existing import path keeps working.
