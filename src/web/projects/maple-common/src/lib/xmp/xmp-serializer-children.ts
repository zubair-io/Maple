 ...
 * local-adjustment containers (#358), then the variants / snapshots /
 * history blocks (#2437), then any unknown passthrough nodes. Takes the raw optional `metadata`/`passthrough`
