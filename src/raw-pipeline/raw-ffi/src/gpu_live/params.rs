...
pub(super) unsafe fn inputs_from_params(p: &MapleGpuLiveParams) -> FullChainInputs {
    ...
    FullChainInputs {
        ...
        hsl_hue: [
            p.hsl_hue_red, p.hsl_hue_orange, p.hsl_hue_yellow, p.hsl_hue_green,
            p.hsl_hue_aqua, p.hsl_hue_blue, p.hsl_hue_purple, p.hsl_hue_magenta,
        ],
        hsl_sat: [
            p.hsl_sat_red, p.hsl_sat_orange, p.hsl_sat_yellow, p.hsl_sat_green,
            p.hsl_sat_aqua, p.hsl_sat_blue, p.hsl_sat_purple, p.hsl_sat_magenta,
        ],
        hsl_lum: [
            p.hsl_lum_red, p.hsl_lum_orange, p.hsl_lum_yellow, p.hsl_lum_green,
            p.hsl_lum_aqua, p.hsl_lum_blue, p.hsl_lum_purple, p.hsl_lum_magenta,
        ],
