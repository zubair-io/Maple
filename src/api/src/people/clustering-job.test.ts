...
// Merge-suggestion tests for prepareClusteringPass/runOnlineClustering live in
// clustering-job.merge-suggestions.test.ts — split out to keep this file
// under the 600-LOC file-budget gate.
