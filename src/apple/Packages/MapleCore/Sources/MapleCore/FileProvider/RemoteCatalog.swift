...
public actor RemoteCatalog {
    ...
    // Shared with ChangeFeedClient — see FileProviderISO8601Decoder.swift
    // for why this doesn't use JSONDecoder's built-in `.iso8601` strategy.
    private let decoder: JSONDecoder = .mapleFileProviderDecoder()
