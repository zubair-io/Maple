...
- **Cloud** — the existing timeline view's feed (see `.archived-plans/specs/2026-05-06-timeline-view-design.md`), already optimised for fast scroll.
...
This section is intentionally light — full plan lands in `.archived-plans/plans/`. The natural slicing:
