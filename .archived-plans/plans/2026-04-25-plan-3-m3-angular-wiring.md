...
> **Brief:** [`.archived-plans/specs/2026-04-25-plan-3-m3-angular-wiring-brief.md`](../specs/2026-04-25-plan-3-m3-angular-wiring-brief.md). This plan implements the brief's § 9 "Recommended cut": **one commit modifying `image-canvas.component.ts`** (plus a public-API check / re-export delta if M2 didn't already wire it).
>
> **Cross-links:**
...
- Modify (final step, append-only): `.archived-plans/plans/2026-04-25-plan-3-m3-angular-wiring.md` — append `## Spike findings` block at end-of-file.
...
Edit `.archived-plans/plans/2026-04-25-plan-3-m3-angular-wiring.md`. Append (at end-of-file, after the last `---` divider) a new section. Replace `<...>` with the actual values from Steps 1.2-1.5:
...
```bash
git add .archived-plans/plans/2026-04-25-plan-3-m3-angular-wiring.md
...
Plan 3 M3 — see .archived-plans/plans/2026-04-25-plan-3-m3-angular-wiring.md.
...
- [ ] Brief reference: `.archived-plans/specs/2026-04-25-plan-3-m3-angular-wiring-brief.md` — verified to exist (file just committed at `6a7b740` per the request prompt).
- [ ] M2 plan reference: `.archived-plans/plans/2026-04-25-plan-3-m2-webgl-shaders.md` — verified by `ls`.
- [ ] M1 plan reference: `.archived-plans/plans/2026-04-25-plan-3-web-ffi-split-m1.md` — verified by `ls`.
- [ ] Plan 3 brief (umbrella): `.archived-plans/specs/2026-04-25-plan-3-web-ffi-split-brief.md` — verified by `ls`.
- [ ] M2 brief: `.archived-plans/specs/2026-04-25-plan-3-m2-webgl-shaders-brief.md` — verified by `ls`.
- [ ] Plan 1 v2 reference: `.archived-plans/plans/2026-04-24-ffi-split-plan-1.md` — verified.
- [ ] Plan 2 v2 (parallel, no conflict): `.archived-plans/plans/2026-04-25-plan-2-v2-dehaze.md` — verified by `ls`.
