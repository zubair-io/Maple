...
pub const TRANSFER_XMP_ATTRIBUTES: &[(&str, &[&str])] = &[
    ...
    ("defringe_purple_amount", &["crs:DefringePurpleAmount"]),
    ("defringe_purple_hue_lo", &["crs:DefringePurpleHueLo"]),
    ("defringe_purple_hue_hi", &["crs:DefringePurpleHueHi"]),
    ("defringe_green_amount", &["crs:DefringeGreenAmount"]),
    ("defringe_green_hue_lo", &["crs:DefringeGreenHueLo"]),
    ("defringe_green_hue_hi", &["crs:DefringeGreenHueHi"]),
    ...
    ("auto_lateral_ca", &["crs:AutoLateralCA"]),
