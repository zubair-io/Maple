...
// component for `/library` on the Self-Hosted shell. Thin wrapper
// around the shared `<app-library-grid>` so the routing layer in this
// app stays free of layout details.
