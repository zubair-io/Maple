...
fn all_struct_field_names() -> Vec<&'static str> {
    let AdjustmentModel {
        ...
        parametric_shadow_split: _,
        parametric_midtone_split: _,
        parametric_highlight_split: _,
        vibrance: _,
        saturation: _,
        clarity: _,
        texture: _,
        ...
        color_grade_shadow_luminance: _,
        color_grade_midtone_hue: _,
        color_grade_midtone_saturation: _,
        color_grade_midtone_luminance: _,
        color_grade_highlight_luminance: _,
        color_grade_global_hue: _,
        color_grade_global_saturation: _,
        color_grade_global_luminance: _,
        ...
        tone_curve_green: _,
        tone_curve_blue: _,
        display_tone_curve_luma: _,
        display_tone_curve_red: _,
        display_tone_curve_green: _,
        display_tone_curve_blue: _,
        chroma_prefilter: _,
