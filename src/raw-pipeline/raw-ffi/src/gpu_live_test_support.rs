...
pub(super) fn make_params(
    ...
    MapleGpuLiveParams {
        ...
        parametric_shadow_split: model.parametric_shadow_split,
        parametric_midtone_split: model.parametric_midtone_split,
        parametric_highlight_split: model.parametric_highlight_split,
