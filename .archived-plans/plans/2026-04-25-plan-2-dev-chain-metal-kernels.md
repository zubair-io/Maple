...
- [ ] Cross-link to Plan 1 v2 (`.archived-plans/plans/2026-04-24-ffi-split-plan-1.md`) is in the header. Cross-link to Plan 1 Task 9's sidecar precondition is in the header's "Plan 1 Task 9 sidecar precondition" callout.
