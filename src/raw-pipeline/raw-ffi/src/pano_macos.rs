...
//!
//! This module is `#[cfg(target_os = "macos")]` only — it is entirely
//! absent from the iOS / iOS-sim compilation units. See `pano.rs` for
//! the entry point, ABI types, and the iOS stub that returns error −3.
