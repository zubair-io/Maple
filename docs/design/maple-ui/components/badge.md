...
screen needs a _pressable_ badge (e.g. a removable filter chip), that's the **Filter Chip**
molecule, not this atom — a removable badge with a close affordance composes at least two atoms,
which is out of this atom's scope.
