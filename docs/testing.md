...
| `file-budget`                      | `bash tools/check-file-budget.sh` — 400 LOC soft (warn), **600 LOC hard** (fail) over `.rs .swift .ts .tsx .js .py`, minus `tools/budget-allowlist.txt`                                                                                                   |
...
| `allowlist-shrinks-only` (PR only) | The LOC allowlist may not gain entries. Split the file instead of allowlisting it                                                                                                                                                                         |
