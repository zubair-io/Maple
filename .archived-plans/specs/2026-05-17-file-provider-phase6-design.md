...
**Prior phases:**
- `.archived-plans/plans/2026-05-14-file-provider-phase1.md` — local mirror + manual refresh
- `.archived-plans/specs/2026-05-16-file-provider-phase2-design.md` — XMP write-back + conflict reconciliation
- `.archived-plans/specs/2026-05-16-file-provider-phase3-design.md` — uploads + soft delete
- `.archived-plans/specs/2026-05-16-file-provider-phase4-design.md` — iOS full mirror
- `.archived-plans/specs/2026-05-16-file-provider-phase5-design.md` — Quick Look + working set + ETag
...
at `.archived-plans/notes/2026-05-17-file-provider-phase5c-perf-audit.md`
calls this out.
...
each. No "directionally fine" — actual numbers, a `.archived-plans/notes/`
file with the table.
