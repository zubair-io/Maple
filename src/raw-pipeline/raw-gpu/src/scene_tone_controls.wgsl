...
//
// A P2 scene-linear stage (epic #925 / #990). Ports the five luma-coupled
...
// * Per-field activation thresholds: exposure |·| ≥ 1e-6; highlights/shadows/
//   whites/blacks |·| ≥ 1e-3. A field below threshold is skipped (its branch
//   does not run), exactly as the Rust `apply_*` flags gate each block.
