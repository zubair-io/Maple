...
export const ADJUSTMENT_RANGES = {
  ...
  defringePurpleAmount: [0.0, 20.0] as const,
  defringePurpleHueLo: [0.0, 100.0] as const,
  defringePurpleHueHi: [0.0, 100.0] as const,
  defringeGreenAmount: [0.0, 20.0] as const,
  defringeGreenHueLo: [0.0, 100.0] as const,
  defringeGreenHueHi: [0.0, 100.0] as const,
} as const;
