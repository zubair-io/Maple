...
| -------------------- | ------------------ | ----------------- | ------------------------------------------------------------ |
| `SceneLinear` (f32)  | 5e-4               | 5e-4              | Demosaic-edge + matrix-mul float drift; scales with L on a 64×64 patch (worst observed ≈ 1.07e-4 at L=0.50) |
...
- Plan implemented at `.archived-plans/plans/2026-04-28-synthetic-grey-dng.md`.
