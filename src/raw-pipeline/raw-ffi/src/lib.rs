...
mod tests {
    ...
    // -----------------------------------------------------------------
    // maple_id_primary / maple_id_fallback — spec-form FFI entries.
    // Each FFI test computes the id via raw_core::MapleId directly and
    // asserts the FFI output matches byte-for-byte. Same fixture-free
    // shape as the BLAKE3 tests above (pure functions over byte slices).
    // -----------------------------------------------------------------
