...
//!
//! S5 effects, parametric tone-curve, and crop/straighten tests are further
//! split into the sibling `tests_effects.rs` (PR #1730 — this file crossed
//! the 600-LOC hard cap on its own).
