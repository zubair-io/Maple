...
///
/// This is the memory-bounded replacement for [`solve_gains`] used in
...
/// cam_j's bounds, push a [`PendingContrib`] into `pending_for_dst[j]` with
/// the source value from frame k and the reprojected (sub-pixel) coordinate
/// in frame j.
///
