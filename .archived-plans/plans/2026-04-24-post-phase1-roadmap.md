...
Pick the next phase to plan in detail. Recommended: **Phase A**. Its plan will follow `superpowers:writing-plans` (TDD steps, exact paths, full code per step, commit after each task), saved as `.archived-plans/plans/2026-04-25-phase-a-perf-instrumentation.md`.
