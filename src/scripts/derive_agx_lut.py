...
# matrices + scalar log-encode constants as WGSL consts, single-sourced from
# the SAME coefficients this script emits to agx_coeffs.rs (the Rust pipeline)
# and the GLSL shader. The 512-entry sigmoid LUT itself is NOT baked as a
# const here: raw-gpu uploads agx_lut.bin to a storage buffer at runtime
