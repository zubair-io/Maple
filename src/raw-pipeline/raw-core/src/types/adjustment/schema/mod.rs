...
pub const ADJUSTMENT_SCHEMA: &[FieldSpec] = &[
    ...
    FieldSpec {
        name: "parametric_shadow_split",
        kind: FieldKind::F32,
        range: (0.0, 100.0),
        default_f32: 25.0,
        enum_name: "",
        doc: "Parametric tone curve — shadow/darks split point (ACR crs:ParametricShadowSplit, #2320).",
    },
    FieldSpec {
        name: "parametric_midtone_split",
        kind: FieldKind::F32,
        range: (0.0, 100.0),
        default_f32: 50.0,
        enum_name: "",
        doc: "Parametric tone curve — darks/lights split point (ACR crs:ParametricMidtoneSplit, #2320).",
    },
    FieldSpec {
        name: "parametric_highlight_split",
        kind: FieldKind::F32,
        range: (0.0, 100.0),
        default_f32: 75.0,
        enum_name: "",
        doc: "Parametric tone curve — lights/highlights split point (ACR crs:ParametricHighlightSplit, #2320).",
    },
    FieldSpec {
        name: "vibrance",
        kind: FieldKind::F32,
