...
> **Brief:** [`docs/superpowers/specs/2026-04-25-plan-3-m2-webgl-shaders-brief.md`](../specs/2026-04-25-plan-3-m2-webgl-shaders-brief.md). This plan implements the brief's § 10 "Recommended cut": **M2.1 only.**
>
> **Cross-links:**
...
- Modify (final step, append-only): `docs/superpowers/plans/2026-04-25-plan-3-m2-webgl-shaders.md` — append `## Spike findings` block at end-of-file.
...
Edit `docs/superpowers/plans/2026-04-25-plan-3-m2-webgl-shaders.md`. Append (at end-of-file, after the last `---` divider) a new section with the captured numbers. Replace `<...>` with the actual values from Steps 1.2 and 1.3:
...
```bash
git add docs/superpowers/plans/2026-04-25-plan-3-m2-webgl-shaders.md
...
- [ ] Brief reference: `docs/superpowers/specs/2026-04-25-plan-3-m2-webgl-shaders-brief.md` — verified to exist (read in plan authoring).
- [ ] Plan 3 brief reference: `docs/superpowers/specs/2026-04-25-plan-3-web-ffi-split-brief.md` — verified.
- [ ] Plan 3 M1 plan reference: `docs/superpowers/plans/2026-04-25-plan-3-web-ffi-split-m1.md` — verified.
- [ ] Plan 1 v2 reference: `docs/superpowers/plans/2026-04-24-ffi-split-plan-1.md` — verified.
- [ ] Plan 2 v2 reference: `docs/superpowers/plans/2026-04-25-plan-2-v2-shared-blur-clarity-texture.md` — verified.
