...
Nothing modifies, deletes, or uploads. The next phase (`.archived-plans/plans/<later>.md`) introduces `modifyItem` for XMP writes, conflict copies, and per-folder pinning policy.
