 ...
 * (#2783: the preview-route ETag flake was exactly that leak).
 */
...
export async function closeDb(): Promise<void> {
  ...
  if (pending) {
    ...
    // client it created. Pre-#2783 this case returned early (no client yet),
    // and the late connect installed itself as the live singleton, leaking
    // past closeDb into the next test file.
