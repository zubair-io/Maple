...
// Playwright runs the Angular dev server against the maple-syrup project and
...
export default defineConfig({
  testDir: './e2e',
  testIgnore: ['batch-transfer/**', 'batch-transfer-ui.spec.ts'],
  fullyParallel: false,
  retries: 0,
  workers: 1,
  reporter: [['list']],
  ...
  webServer: {
    command: 'bun x ng serve maple-syrup --port 4200',
    port: 4200,
